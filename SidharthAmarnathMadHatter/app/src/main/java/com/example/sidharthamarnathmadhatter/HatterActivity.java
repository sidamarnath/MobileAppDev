...
public class HatterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSpinner().setOnItemSelectedListener(new Spinner.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View view,
                ...
                getHatterView().disableButton(getColorButton());
            }
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode() == Activity.RESULT_OK) {
                        ...
                        int color = intent.getIntExtra(ColorSelectActivity.COLOR, Color.BLACK);
    ...
    public void onColor(View view) {
        Intent switchActivityIntent = new Intent(this, ColorSelectActivity.class);
        pickColorResultLauncher.launch(switchActivityIntent);
    }
